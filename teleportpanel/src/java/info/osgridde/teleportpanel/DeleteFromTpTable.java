 ...
 * @author Akira Sonoda
 */
@WebServlet(name = "DeleteFromTpTable", urlPatterns = {"/DeleteFromTpTable"})
public class DeleteFromTpTable extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (paramMap.size() != 2) {
                ...
                tpTableService.deleteFromTpTable(controlRegion,destRegion);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DeleteFromTpTable.class.getName()).log(Level.SEVERE, null, ex);
